...
for line in lines:
    ...
    if line_stripped.startswith('question:') or line_stripped.startswith('"question":'):
        ...
        if first_quote_idx != -1 and last_quote_idx != -1 and first_quote_idx != last_quote_idx:
            ...
            # Normalize for better matching: remove spaces and ALL punctuation
...
print(f"Total unique questions (normalized): {len(questions_seen)}")
if len(duplicates) == 0:
    print("No duplicates found even after removing punctuation!")
else:
